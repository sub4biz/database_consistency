...
- Fix `ForeignKeyCascadeChecker` to handle missing primary key (no-primary-key tables) and support composite foreign/primary keys. Thanks [Andy Allan](https://github.com/gravitystorm) for reporting this!
